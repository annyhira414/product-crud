...
const CreateUpdateProduct = () => {
  ...
  const createProduct = async () => {
    try {
      ...
      const response = await axios.post("https://hotel.aotrek.net/api/auth/create", data, {
        headers: {
  ...
  const updateProduct = async () => {
    try {
      ...
      const response = await axios.put(`https://hotel.aotrek.net/api/auth/update/${product?.id}`, data, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  return (
    <>
      <Topbar title={type === "EDIT" ? "Update product" : "Create new product"} />
      <form
